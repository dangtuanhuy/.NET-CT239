...
namespace MyWatchWatch.Areas.Management.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeCode,EmployeePass,LastName,FirstName,EmployeeGender,BirthDate,EmployeImg,EmployeeEmail,EmployeeAddress,RoleId,Create_Emp,Status_Emp")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeCode,EmployeePass,LastName,FirstName,EmployeeGender,BirthDate,EmployeImg,EmployeeEmail,EmployeeAddress,RoleId,Create_Emp,Status_Emp")] Employee employee)
        {
            if (ModelState.IsValid)
            {
